...
export async function getPageInfo(
  ...
  if (args.includeAccessibilityTree) {
    try {
      ...
      const axTree = await relay.sendCommand('Accessibility.getFullAXTree', {}, sessionId) as {
        nodes?: Array<{ nodeId?: string; role?: { value?: string }; name?: { value?: string }; properties?: unknown[] }>;
      };
